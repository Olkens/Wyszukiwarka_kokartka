            ...
            <div class="tr-info-3">
                <div class="tr-info-3-box tr-border-left">
                    ...
                    <div>
                        ...
                        <p v-if="trening.group.includes('kokartka')" class="Kokartka-color">Kokartka</p>
                        <p v-else-if="trening.group.includes('mucha')" class="Mucha-color">Mucha</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="tr-btn-container">
            <a class="tr-btn tr-btn-wi" :href="trening.descObj">Więcej Informacji</a>
            <a class="tr-btn tr-btn-zs" :href="trening.signUp" target="_blank"> Zapisz się</a>
        </div>
    </div>
</template>
