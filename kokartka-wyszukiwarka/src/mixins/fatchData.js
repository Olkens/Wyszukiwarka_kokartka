            ...
            apitab.push({
              ...
              firstDate: data[i].dates[0]
                ? new Date(data[i].dates[0]).getHours() +
                  ":" +
                  String(new Date(data[i].dates[0]).getMinutes()).padStart(
                    2,
                    "0"
                  )
                : "",
              secondDate: data[i].dates[1]
                ? new Date(data[i].dates[1]).getHours() +
                  ":" +
                  String(new Date(data[i].dates[1]).getMinutes()).padStart(
                    2,
                    "0"
                  )
                : "",
              ...
              firstDay: data[i].dates[0]
                ? new Date(data[i].dates[0]).toLocaleDateString("pl-PL", {
                    weekday: "long",
                  })
                : "",
              secondDay: data[i].dates[1]
                ? new Date(data[i].dates[1]).toLocaleDateString("pl-PL", {
                    weekday: "long",
                  })
                : "",
              thirdDay: data[i].dates[2]
                ? new Date(data[i].dates[2]).toLocaleDateString("pl-PL", {
                    weekday: "long",
                  })
                : "",
